...
#region
	...
	//v_ref_space_pos, obj_hash,	v_vTexcoord
	_take1 = returnRandom(	(	mod(v_vTexcoord.x*1024.,17.) + mod(v_ref_space_pos.y,23.) + mod(v_ref_space_pos.z,31.)	)*.03	,3.)/251.;
	_take2 = returnRandom(	(	mod(v_ref_space_pos.x,29.) + mod(v_vTexcoord.y*1024.,37.) + mod(obj_hash,19.)	)*.03	,3.)/257.;
					
	_take3 = returnRandom(	(	mod(v_vTexcoord.x*1024.,23.) + mod(v_ref_space_pos.x,17.) + mod(v_ref_space_pos.y,41.)	)*.03	,3.)/241.;
	_take4 = returnRandom(	(	mod(v_ref_space_pos.z,59.) + mod(v_vTexcoord.y*1024.,67.) + mod(obj_hash,31.)	)*.03	,3.)/263.;
					
	_take5 = returnRandom(	(	mod(v_vTexcoord.x*1024.,19.) + mod(v_ref_space_pos.x,31.) + mod(v_ref_space_pos.z,43.)	)*.03	,3.)/269.;
	_take6 = returnRandom(	(	mod(v_ref_space_pos.y,17.) + mod(v_vTexcoord.y*1024.,41.) + mod(obj_hash,47.)	)*.03	,3.)/233.;
					
	_tcr1 = texture2D(tex_rnd_noise,vec2(_take1,_take4));
	_tcr2 = texture2D(tex_rnd_noise,vec2(_take2,_take5));
	_tcr3 = texture2D(tex_rnd_noise,vec2(_take3,_take6));
...
#region		//(is_material == 1.)
	...
	_take1 = returnRandom(	(	mod(v_vTexcoord.x*1024.,17.) + mod(v_ref_space_pos.y,23.) + mod(v_ref_space_pos.z,31.)	)*.001	,3.)/256.;
	_take2 = returnRandom(	(	mod(v_ref_space_pos.x,29.) + mod(v_vTexcoord.y*1024.,37.) + mod(obj_hash,19.)	)*.001	,3.)/256.;
	...
	_take3 = returnRandom(	(	mod(v_vTexcoord.x*1024.,17.) + mod(v_ref_space_pos.x,23.) + mod(v_ref_space_pos.y,31.)	)*.001	,3.)/256.;
	_take4 = returnRandom(	(	mod(v_ref_space_pos.z,29.) + mod(v_vTexcoord.y*1024.,37.) + mod(obj_hash,19.)	)*.001	,3.)/256.;
	...
	_take5 = returnRandom(	(	mod(v_vTexcoord.x*1024.,17.) + mod(v_ref_space_pos.x,23.) + mod(v_ref_space_pos.z,31.)	)*.001	,3.)/256.;
	_take6 = returnRandom(	(	mod(v_ref_space_pos.y,29.) + mod(v_vTexcoord.y*1024.,37.) + mod(obj_hash,19.)	)*.001	,3.)/256.;
	...
	_tcr1 = texture2D(tex_rnd_noise,vec2(_take1,_take2));
	vec4 _tcr11 = texture2D(tex_rnd_noise,vec2(_take11,_take21));
	_tcr2 = texture2D(tex_rnd_noise,vec2(_take3,_take4));
	vec4 _tcr21 = texture2D(tex_rnd_noise,vec2(_take31,_take41));
	_tcr3 = texture2D(tex_rnd_noise,vec2(_take5,_take6));
