function exe_add_single_floor_3x3(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	if array_length(_initial_pm) == 16	
		{	
			var _delta = [0,0,0];
			_delta = exe_move_fb(_delta,_posMat,120.);
			//_delta = exe_move_updown(_delta,_posMat,0.);
			//_delta = exe_move_sides(_delta,_posMat,0.);
			_posMat = exe_delta_add_Mat(_delta,_posMat);
		};

	_temp_o.character_sheet = {		name: "floor_3x3_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
	...
	struct_set(_temp_o.character_sheet, "items_swaps",		"floor_items_swaps_3x3_01"	);
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_floor_3x3_01_show","1.","N"],				["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],								["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],								["vbuff_empty","1.","N"],								];
	_temp_o.part_texture_shader_setings =		[	[7.,1.,0.],											[101.,5.,0.],										[7.,1.,0.],												[7.,1.,0.],											[7.,1.,0.],												[7.,1.,0.],												];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_floor_3x3_01_colider","1.","N"],			["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],								["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],								["vbuff_empty","1.","N"],								];
	...
	_temp_o.part_dependency_load_reference =	[	["main_part",[[0.,0.,0.,0.,0.,0.,0.,0.,0.]]	],		["main_part",[[0.,0.,0.,0.,0.,0.,0.,0.,0.]]	],		["main_part",[[0.,0.,0.,0.,0.,120.,0.,0.,90.]]	],		["main_part",[[0.,0.,0.,120.,0.,0.,0.,0.,0.]]	],	["main_part",[[0.,0.,0.,0.,0.,-120.,0.,0.,270.]]	],	["main_part",[[0.,0.,0.,-120.,0.,0.,0.,0.,180.]]	],	];
