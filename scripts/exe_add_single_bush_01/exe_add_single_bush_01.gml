function exe_add_single_bush_01(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.character_sheet = {		name: "bush_swapable_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
									file_name : "bush_swapable_01.txt", file_directory : "terrain/",};
	_temp_o.control_method = {};
	//_temp_o.camera =[];
	
	struct_set(_temp_o.character_sheet, "render_pass_sorting",		"static_minor"	);
	struct_set(_temp_o.character_sheet, "items_swaps",		"bush_items_swaps_01"	);
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_bush_01","1.","N"]						];
