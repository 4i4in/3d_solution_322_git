	...
	if menus.test_menu.minimised > 0	//minimsed
		{
			...
			var _restricted = [_xref,_yref,_xref + _menu_xsize,_yref + _menu_ysize,menus.test_menu.menu_background,menus.test_menu.menu_border];
