function exe_add_single_corridor_L3_flat(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.character_sheet = {		name: "corridor_L3_flat_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
	...
	struct_set(_temp_o.character_sheet, "items_swaps",		"corridor_items_swaps_L3_flat_01"	);
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_corridor_01_w3d1_show","1.","N"],			["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],							];
	_temp_o.part_texture_shader_setings =		[	[7.,1.,0.],											[101.,5.,0.],										[7.,1.,0.],											];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_corridor_01_w3d1_collider","1.","N"],		["vbuff_empty","1.","N"],							["vbuff_empty","1.","N"],							];
	...
	_temp_o.part_dependency_load_reference =	[	["main_part",[[0.,0.,0.,0.,0.,0.,0.,0.,0.]]	],		["main_part",[[0.,0.,0.,0.,0.,0.,0.,0.,0.]]	],		["main_part",[[0.,0.,0.,0.,0.,250.,0.,0.,90.]]	],	];
