function exe_add_paint_grass_01_d100(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.character_sheet = {		name: "paint_grass_01_d100", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
									file_name : "paint_grass_01_d100.txt", file_directory : "terrain/",};
	_temp_o.control_method = {};
	//_temp_o.camera =[];
	
	struct_set(_temp_o.character_sheet, "items_swaps",		"paint_d100_items_swaps_01"	);
	
	_temp_o.character_sheet.body_measures =	{ biome_paint : 1.,	biome_radius : 50.,	biome_chance_up : 20.,	granulation : 20.,	biome : ["grassland_low_small"]};
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_helper_gras_01_d100","1.","N"]				];
	_temp_o.part_texture_shader_setings =		[	[7.,1.,0.]			];	//material true/false
	...
	_temp_o.part_colision_method =				[	"biome_paint"											];
