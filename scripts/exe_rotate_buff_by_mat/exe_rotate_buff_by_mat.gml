	...
	for(var _ii = 0; _ii < buffer_get_size(_new_buff_here); _ii+= (32 * 3)	)//because of triangle
		{
			...
			//normal 1,2,3
			var _n_ox = buffer_peek(_new_buff_here, _ii + 12, buffer_f32);
			var _n_oy = buffer_peek(_new_buff_here, _ii + 16, buffer_f32);
			var _n_oz = buffer_peek(_new_buff_here, _ii + 20, buffer_f32);
			...
			buffer_poke(_new_buff_here, _ii + 12, buffer_f32, _n_nx);
			buffer_poke(_new_buff_here, _ii + 16, buffer_f32, _n_ny);
			buffer_poke(_new_buff_here, _ii + 20, buffer_f32, _n_nz);
			...
			//normal 2
			buffer_poke(_new_buff_here, _ii + 12+32, buffer_f32, _n_nx);
			buffer_poke(_new_buff_here, _ii + 16+32, buffer_f32, _n_ny);
			buffer_poke(_new_buff_here, _ii + 20+32, buffer_f32, _n_nz);
			...
			//normal 3
			buffer_poke(_new_buff_here, _ii + 12+64, buffer_f32, _n_nx);
			buffer_poke(_new_buff_here, _ii + 16+64, buffer_f32, _n_ny);
			buffer_poke(_new_buff_here, _ii + 20+64, buffer_f32, _n_nz);
