	...
	if _colision_type == "solid"
		{
			...
			var _cast_up =		_delta[0] * (-_posMat[8]) +
								_delta[1] * (-_posMat[9]) +
								_delta[2] * (-_posMat[10]);
			...
			if array_length(_obj.control_method.anchor) > 0
				...
				//check up/down
							case "col_nck_up":
								_obj.control_method.anchor[0][1][0] -= _posMat[8]*_cast_up;
								_obj.control_method.anchor[0][1][1] -= _posMat[9]*_cast_up;
								_obj.control_method.anchor[0][1][2] -= _posMat[10]*_cast_up;
								break;
				//check up/down			
							case "col_ass_down":
								_obj.control_method.anchor[0][1][0] -= _posMat[8]*_cast_up;
				...
				{	//push main	
					...
					//check up/down			
							case "col_nck_up":
								_obj.part_posMat[_main_id][12] -= _posMat[8]*_cast_up;
								_obj.part_posMat[_main_id][13] -= _posMat[9]*_cast_up;
								_obj.part_posMat[_main_id][14] -= _posMat[10]*_cast_up;
								break;
					//check up/down			
							case "col_ass_down":
								_obj.part_posMat[_main_id][12] -= _posMat[8]*_cast_up;
