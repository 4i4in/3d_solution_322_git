function exe_add_single_corridor_01(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.character_sheet = {		name: "corridor_swapable_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
	...
	struct_set(_temp_o.character_sheet, "items_swaps",		"corridor_items_swaps_01"	);
